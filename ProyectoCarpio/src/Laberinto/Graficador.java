...
public class Graficador {
    ...
    private double nodoSize = 1;
    private String propTamNodo = "width="+nodoSize+",height="+nodoSize+"";


    
    private String mazeRunCaminoActual(Genotipo genotipo){
    ...
    private String mazeRun(Hijo h, int anterior, int nivel, String npadre, double x, double y) {
        String t = "";
        if (h == null) {
            return t;
        }
